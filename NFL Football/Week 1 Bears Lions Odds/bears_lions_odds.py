...
colors = ["#e15f1a", "#e15f1a", "gray", "blue", "blue"]
for ytick, color in zip(ax.get_yticklabels(), colors):
    ytick.set_color(color)

# Adds the text to the plot
plt.annotate("LIONS WIN PROBABILITY", (-2600, .98), color="blue", fontweight="bold")
plt.annotate("BEARS WIN PROBABILITY", (-2600, .02), color="#e15f1a", fontweight="bold")

# Creates the title
plt.title("NFL Week 1 Bears @ Lions Vegas Live Odds", weight="bold")
